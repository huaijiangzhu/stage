...
class PI2CMA(Optimizer):
    ...
    def __init__(self, na, horizon,
                 ...
                 epsilon=0.001, alpha=0.1, gamma=0.99):
        super().__init__()
        ...
        self.num_elites = int(self.pop_size)
